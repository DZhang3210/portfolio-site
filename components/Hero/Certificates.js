    ...
    <div className='flex flex-col gap-5 py-10'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 justify-between gap-10'>
            {[
                ...
                ["/Google-Data-Analytics-Icon.png", 'Google Certified','Data Analytics','Certified in key analytical skills (data cleaning, analysis, & visualization) and tools (spreadsheets, SQL, R programming, Tableau)']].map(([src, org, title, desc]) => (
                    <div className='flex flex-row items-center justify-center gap-4 rounded-lg border p-2 border-primary'>
                        <Image
                            src = {src}
                            alt = {src}
                            height = {130}
