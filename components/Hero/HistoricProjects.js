      ...
      <div className='flex flex-col gap-5'>
        {
            ...
            ["Top Down Shooter", "June 2015", "Dec 2018", ["Top-down, bullet hell, shooter", "Unique AI Enemies features: lasers, invisibility, fast-chasing, passive behavior", "Unity, C#, Particle Effects, Sprites/Maps, Animation, Logic"]]].map(([title, start, end, points])=>(
                <div className='flex flex-col border-b-2 border-b-black rounded-md p-4'>
                    ...
                    <div className='flex flex-col gap-1 text-md text-gray-500'>
                        {
                            points.map((point)=>(
                                <div className='indent-1'>{point}</div>
                            ))
                        }
                    </div>
                </div>
